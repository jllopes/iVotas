...
public interface RMI_Interface_Admin {
    public boolean register(String name, String username, String password, int type, String address, int num_id, int month_id, int year_id, String phoneNumber);
    ...
    public void createElection(Date startDate, Date endDate, String name, String desc, int type);
